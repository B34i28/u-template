...
export default function Hero() {
  return (
    <div className='relative sm:w-[640px] xl:w-[1280px] md:w-[768px] lg:w-[1024px] overflow-visible'>
        <div className=''>
            <Image src={Carimg} alt='Car Image' />
        </div>

        <div className='xl:top-[21rem] xl:left-[320px] absolute flex md:w-[695px] w-[380px] top-28 lg:top-36 lg:left-6 lg:pl-10 xl:pl-10 flex-col border-4 pb-32 lg:w-[1024px] rounded-lg justify-center xl:w-[1160px] xl:h-[698]  bg-[#FFFFFF] shadow-[#4E4E4E] '>
            <div className='md:w-auto w-[330px] lg:w-[945px] xl:w-[1073px] bg-gray-200 xl:h-[48px]'>
                <Image src={Heroicons} alt='Hero Icons' />
            </div>


            <div className='md:w-auto w-[330px] lg:w-[945px] space-y-5 mt-8 border-b-[1px] pb-9 stroke-[#B8B8B8] mb-4'>
                <div className='xl:flex space-y-1 lg:flex md:flex-row md:flex grid grid-cols-2 lg:space-x-9 xl:space-x-3'>
                ...
                <div className='xl:flex space-y-1 lg:flex md:flex-row md:flex grid grid-cols-2 lg:space-x-3 xl:space-x-3'>
                ...
                <div className='space-y-1 md:items-center xl:flex lg:flex md:flex-row md:flex grid grid-cols-2 lg:space-x-3 xl:space-x-3'>
                    <p className=' xl:w-[154px] xl:h-[52px] top-[-3098px] left-[-81px] rounded-[8px] border-[1px] stroke-[#B8B8B8] items-center pl-3 flex md:w-28 w-40 h-11 bg-[#FFFFFF] text-[#444444] justify-between'>Fuel type <ChevronDown /></p>
                    <div className='flex items-center rounded-[8px] border-[1px] bg-[#FFFFFF] text-[#444444]'>
                        <p className=' xl:w-[154px] xl:h-[52px] top-[-3098px] left-[-81px] rounded-[8px] border-[1px] stroke-[#B8B8B8] items-center pl-3 flex md:w-32 w-40 h-11 bg-[#FFFFFF] text-[#444444]'>Payment Type</p>
                        <button className='hidden md:block lg:block xl:block md:w-28 w-[160px] lg:px-[60px] h-[52px] top[-3098px] left-[85px] rounded-[8px] border-[1px] stroke-[#B8B8B8] bg-[#EF2C2E] text-[#FFFFFf]'>Buy</button>
                        <p className='md:w-24 w-[135px] h-[52px] rounded-x-[8px] rounded-y-[0px] border-l-[1px] border-t-[1px] border-b-[1px] border-r-[0px] stroke-[#B8B8B8] bg-[#FFFFFF] text-[#444444] items-center flex md:pl-3 xl:pl-3 '>Leasing</p>
                    </div>
            ...
            <div>
                ...
                <div className=' w-[330px] lg:flex xl:flex md:flex-row md:flex grid grid-cols-2 mt-5 space-x-3 lg:space-x-7 '>
                    <div className='lg:w-60 xl:w-[260px] xl:h-[84px] rounded-[8px]  stroke-[#B8B8B8] text-[#444444] '>
                        ...
                        <div className='flex lg:mt-1 xl:mt-1 mt-7'>
                            <p className='text-[#444444] xl:w-[126px] lg:w-[126px] flex items-center pl-3 lg:h-[44px] xl:h-[52px] md:w-24 w-40 h-11 rounded-[8px] border-[1px] stroke-[#B8B8B8] bg-[#FFFFFF] justify-between'>From <ChevronDown /></p>
                            <p className='text-[#444444] xl:w-[126px] lg:w-[126px] flex items-center pl-3 lg:h-[44px] xl:h-[52px] md:w-24 w-40 h-11 rounded-[8px] border-[1px] stroke-[#B8B8B8] bg-[#FFFFFF] justify-between'>To <ChevronDown /></p>
                        </div>
                    </div>
                    ...
                    <div className=' lg:w-60 xl:w-[260px] xl:h-[84px] rounded-[8px]  stroke-[#B8B8B8] text-[#444444] '>
                        ...
                        <div className='flex lg:mt-1 xl:mt-1 mt-8'>
                            <p className='text-[#444444] xl:w-[126px] lg:h-[44px] xl:h-[52px] flex items-center pl-3 rounded-[8px] md:w-24 w-40 h-11 border-[1px] stroke-[#B8B8B8] bg-[#FFFFFF] justify-between'>From <ChevronDown /></p>
                            <p className='text-[#444444] xl:w-[126px] lg:h-[44px] xl:h-[52px] flex items-center pl-3 rounded-[8px] md:w-24 w-40 h-11 border-[1px] stroke-[#B8B8B8] bg-[#FFFFFF] justify-between'>Up to <ChevronDown /></p>
                        </div>
                    </div>
                </div>


                <div className='w-[330px] lg:flex xl:flex lg:space-x-4 md:flex-row md:flex grid grid-cols-2 mt-5 space-x-3 border-b-[1px] pb-9'>
                    <div className='lg:w-60 xl:w-[260px] xl:h-[84px] rounded-[8px]  stroke-[#B8B8B8] text-[#444444] '>
                        <h1 className='text-lg font-semibold text-[#1E1E1E] '>Leasing Duration</h1>
                        <div className='flex xl:mt-1 lg:mt-1 mt-8'>
                            <p className='text-[#444444] xl:w-[126px] md:w-24 w-40 h-11 lg:h-[44px] xl:h-[52px] flex items-center pl-3 rounded-[8px] border-[1px] stroke-[#B8B8B8] bg-[#FFFFFF] justify-between'>From <ChevronDown /></p>
                            <p className='text-[#444444] xl:w-[126px] md:w-24 w-40 h-11 lg:h-[44px] xl:h-[52px] flex items-center pl-3 rounded-[8px] border-[1px] stroke-[#B8B8B8] bg-[#FFFFFF] justify-between'>To <ChevronDown /></p>
                        </div>
                    </div>
